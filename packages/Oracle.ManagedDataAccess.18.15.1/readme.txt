Oracle.ManagedDataAccess NuGet Package 18.15.1 README
=====================================================
Release Notes: Oracle Data Provider for .NET, Managed Driver

January 2023

This README supplements the main ODP.NET 18c documentation.
https://docs.oracle.com/en/database/oracle/oracle-data-access-components/18.3/
...
Bug Fixes since Oracle.ManagedDataAccess NuGet Package 18.15.0
==============================================================
